...
async function main() {
  ...
  await prisma.timetableElement.create({
    data: {
      ...
      endTime: new Date(1970, 0, 1, 8, 40),
      alternating: false,
      split: false,
      yearId: 1,
      studentClassId: studentClass1.id,
  ...
  await prisma.timetableElement.create({
    data: {
      ...
      period: 2,
      day: 'Monday',
      startTime: new Date(1970, 0, 1, 8, 40),
      endTime: new Date(1970, 0, 1, 9, 20),
      alternating: false,
      split: false,
      yearId: 1,
      studentClassId: studentClass1.id,
  ...
  await prisma.timetableElement.create({
    data: {
      ...
      period: 3,
      day: 'Monday',
      startTime: new Date(1970, 0, 1, 9, 30),
      endTime: new Date(1970, 0, 1, 10, 10),
      alternating: false,
      split: false,
      yearId: 1,
      studentClassId: studentClass1.id,
  ...
  await prisma.timetableElement.create({
    data: {
      ...
      period: 3,
      day: 'Monday',
      startTime: new Date(1970, 0, 1, 10, 10),
      endTime: new Date(1970, 0, 1, 10, 50),
      alternating: false,
      split: false,
      yearId: 1,
      studentClassId: studentClass1.id,
